...
let swapRefCorrect m n = 
    let temp = !m
    m <- n
    n <- temp

let mutable m1 = ref 10
let mutable n1 = ref 20

swapRefCorrect m1 n1
printf "%d %d" !m1 !n1 //Prints 20 10 as expected

let swapListRefCorrect o p = 
    let temp = !o
    o <- p
    p <- temp

let mutable o1 = ref [1;2;3]
let mutable p1 = ref [4;5;6]

swapListRefCorrect o1 p1
printf "%A %A" !o1 !p1 //Prints [4;5;6] [1;2;3] as expected